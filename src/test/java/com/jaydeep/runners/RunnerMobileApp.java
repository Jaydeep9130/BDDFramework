...
@CucumberOptions(features = "src/test/resources/features", glue = { "com.cognizant.steps" }, tags = "@Mobile" , monochrome = true, plugin = { "pretty", "pretty:target/cucumber-report/pretty.txt",
